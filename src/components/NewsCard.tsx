...
export function NewsCard({ variant, title, category, location, time, verified }: NewsCardProps) {
  if (variant === "featured") {
    return (
      <div className="rounded-[var(--radius-xl)] overflow-hidden relative mx-4 md:mx-8 lg:mx-12 mb-4 md:mb-6 shadow-sm">
        ...
        <div 
          className="w-full min-h-[100px] relative flex flex-col justify-end"
        ...
        >
          ...
          <div className="relative p-5 z-10 flex flex-col items-start gap-2 md:gap-3">
            ...
            <h3 className="text-[var(--text-micro)] font-medium text-white leading-[1.3]">
              {title}
            </h3>
          </div>
        </div>
